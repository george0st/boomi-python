...
class AtomDiskSpaceAsyncResponse(BaseModel):
    ...
    :type result: List[AtomDiskSpace], optional
    """
    ...
    def __init__(
        ...
        result: List[AtomDiskSpace] = SENTINEL,
        **kwargs,
    ):
        """AtomDiskSpaceAsyncResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, AtomDiskSpace)
        self._kwargs = kwargs
