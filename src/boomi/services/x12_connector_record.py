...
class X12ConnectorRecordService(BaseService):

    @cast_models
    def query_x12_connector_record(
        self, request_body: X12ConnectorRecordQueryConfig = None
    ) -> Union[X12ConnectorRecordQueryResponse, str]:
        ...
        :type request_body: X12ConnectorRecordQueryConfig, optional
        ...
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/X12ConnectorRecord/query",
    ...
    def query_more_x12_connector_record(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/X12ConnectorRecord/queryMore",
                [self.get_access_token(), self.get_basic_auth()],
            )
            .serialize()
            .set_method("POST")
