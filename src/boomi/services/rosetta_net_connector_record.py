...
class RosettaNetConnectorRecordService(BaseService):

    @cast_models
    def query_rosetta_net_connector_record(
        self, request_body: RosettaNetConnectorRecordQueryConfig = None
    ) -> Union[RosettaNetConnectorRecordQueryResponse, str]:
        ...
        :type request_body: RosettaNetConnectorRecordQueryConfig, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        :return: The parsed response data.
        :rtype: Union[RosettaNetConnectorRecordQueryResponse, str]
        """

        Validator(RosettaNetConnectorRecordQueryConfig).is_optional().validate(
            request_body
        )

        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/RosettaNetConnectorRecord/query",
        ...
        if content == "application/json":
            return RosettaNetConnectorRecordQueryResponse._unmap(response)
        if content == "application/xml":
            return RosettaNetConnectorRecordQueryResponse._unmap(parse_xml_to_dict(response))
    ...
    def query_more_rosetta_net_connector_record(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/RosettaNetConnectorRecord/queryMore",
                [self.get_access_token(), self.get_basic_auth()],
            )
            .serialize()
            .set_method("POST")
